class cli_flags:
    ...
    def get_help_text(self):
        ...
        return '\n\n\tФлаги:\n' \
               ...
               f'\t  {self.__cookie} <количество> <название 1> <значение 1> <название 2> <значение 2> - Cookies.\n' \
               f'\tВ названии Cookie не должно содержаться пробелов. В значении Cookie пробелы должны быть заменены на ' \
               f'нижнее подчеркивание (_)\n' \
