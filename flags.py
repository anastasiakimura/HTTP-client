class cli_flags:
    ...
    def get_help_text(self):
        ...
        return '\n\n\tФлаги:\n' \
               ...
               ' ... - HTTP заголовки.' \
               '\n\t     В значении заголовка нужно вместо пробелов указывать нижние подчеркивания (_). Количество заголовков' \
               ...
               f'\t  {self.__save_in_file} <абсолютный путь до файла> - этот флаг подключает возможность сохранить ответ файл\n' \
